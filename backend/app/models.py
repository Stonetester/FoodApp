...
class PantryItem(db.Model):
    ...
    serving_size_text = db.Column(db.String(255))
    servings_per_container = db.Column(db.String(64))
    package_size_text = db.Column(db.String(255))
    ...
    def to_dict(self):
        ...
        return {
            ...
            'package_size_text': self.package_size_text
        }
